...
function getGithubAPIInfo($githubAPIURL, $context) {
...
function getGithubAPIURL($githubAPIURL, $mainArray){
  $urlArray = array();
...
function checkURLStatus($urlAPIArray, $context, $githubAPIURL) {
  $mask = "|%6.6s |%-60.60s |\n";
...
// Functions to run
$mainArray = getGithubAPIInfo($githubAPIURL, $context);
$urlAPIArray = getGithubAPIURL($githubAPIURL, $mainArray);
checkURLStatus($urlAPIArray, $context, $githubAPIURL);
?>